...
export const demoOptionCards: ActivityDocument = {
...
export const demoTrueFalse: ActivityDocument = {
  id: "demo-true-false",
...
export const demoDragDrop: ActivityDocument = {
  id: "demo-drag-drop",
...
export const demoPhraseCompletion: ActivityDocument = {
...
export const demoSequence: ActivityDocument = {
  id: "demo-sequence",
...
export const demoClassification: ActivityDocument = {
